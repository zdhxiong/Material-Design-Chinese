                ...
                <figure class="s-tag-media">
                  <div class="media" style="max-width: 3000px">
                    <div class="frame " style="padding-top: 100.0%">
                      <img alt="" src="<?= static_url('../static/media/material-design/elevation-shadows/what_is_material_elevation_and_shadows.png'); ?>" loading="lazy"/>
                    </div>
                  </div>
                </figure>
              </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 63.1578947368%">
                          <img alt="" aria-describedby="elevation-android-figure-caption-0" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation1.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 2320px">
                        <div class="frame " style="padding-top: 41.3793103448%">
                          <img alt="" aria-describedby="elevation-android-figure-caption-1" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation2.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 2320px">
                        <div class="frame " style="padding-top: 41.3793103448%">
                          <img alt="" aria-describedby="elevation-android-figure-caption-2" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation3.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 2320px">
                        <div class="frame " style="padding-top: 41.3793103448%">
                          <img alt="" aria-describedby="elevation-android-figure-caption-3" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation4.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="figure-figure-figure col-3">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 100.0%">
                          <img alt="" aria-describedby="shadows-figure-caption-0" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_shadow1.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 100.0%">
                          <img alt="" aria-describedby="shadows-figure-caption-1" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_shadow2.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 100.0%">
                          <img alt="" aria-describedby="shadows-figure-caption-2" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_shadow3.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="figure-figure-figure col-3">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 100.0%">
                          <img alt="" aria-describedby="shadows-figure-caption-3" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_shadow4.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 100.0%">
                          <img alt="" aria-describedby="shadows-figure-caption-4" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_shadow5.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 100.0%">
                          <img alt="" aria-describedby="shadows-figure-caption-5" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_shadow6.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 21.4473684211%">
                          <img alt="" aria-describedby="shadows-figure-caption-6" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_component06.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 27.7631578947%">
                          <img alt="" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_component02.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    </figure>
                  </div>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 27.7631578947%">
                          <img alt="" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_component08.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    </figure>
                  </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 52.5%">
                          <img alt="" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_component03.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    </figure>
                  </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1522px">
                        <div class="frame " style="padding-top: 87.3850197109%">
                          <img alt="" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_component09.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    </figure>
                  </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 50.3947368421%">
                          <img alt="" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_component12.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    </figure>
                  </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 95.1315789474%">
                          <img alt="" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_component10.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    </figure>
                  </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 42.5%">
                          <img alt="" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_component11.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    </figure>
                  </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 17.2368421053%">
                          <img alt="" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_component05.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    </figure>
                  </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 62.1052631579%">
                          <img alt="" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_component04.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    </figure>
                  </div>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 21.4473684211%">
                          <img alt="" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_component07.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    </figure>
                  </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 19.0789473684%">
                          <img alt="" src="<?= static_url('../static/media/material-design/elevation-shadows/whatismaterial_3d_elevation_component01.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    </figure>
                  </div>
                      ...
                      <div class="media" style="max-width: 1520px">
                        <div class="qp-ui frame" data-qp-ui="{ 'VideoPlayer': {} }" role="button" style="padding-top: 63.1578947368%">
                          <video aria-describedby="object-relationships-figure-caption-0" controls="" loop="" preload="auto">
                            <source src="<?= static_url('../static/media/material-design/elevation-shadows/WhatIsMaterial_ObjectsIn3DSpace_ObjectRelationships_01_RaisedChildButton_001.webm'); ?>" type="video/webm">
                            <source src="<?= static_url('../static/media/material-design/elevation-shadows/WhatIsMaterial_ObjectsIn3DSpace_ObjectRelationships_01_RaisedChildButton_001.mp4'); ?>" type="video/mp4">
                            </source></source>
                          </video>
                        </div>
                      </div>
                      ...
                      <div class="media" style="max-width: 1520px">
                        <div class="qp-ui frame" data-qp-ui="{ 'VideoPlayer': {} }" role="button" style="padding-top: 63.1578947368%">
                          <video aria-describedby="object-relationships-figure-caption-1" controls="" loop="" preload="auto">
                            <source src="<?= static_url('../static/media/material-design/elevation-shadows/WhatIsMaterial_ObjectsIn3DSpace_ObjectRelationships_02_FAB_001.webm'); ?>" type="video/webm">
                            <source src="<?= static_url('../static/media/material-design/elevation-shadows/WhatIsMaterial_ObjectsIn3DSpace_ObjectRelationships_02_FAB_001.mp4'); ?>" type="video/mp4">
                            </source></source>
                          </video>
                        </div>
                      </div>
