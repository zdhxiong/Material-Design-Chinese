    ...
    <div class="chapter-content">
      ...
      <div class="article-content chapter-intro">
        <div>
          <figure class="s-tag-media">
            <div class="media">
              <img alt="" src="../static/media/material-design/introduction/materialdesign_introduction.png"/>
            </div>
            <figcaption>
      ...
      <nav class="chapter-toc">
        ...
        <ul>
          ...
          <li>
            <a class="gweb-smoothscroll-control qp-ui" data-qp-ui="{ 'SmoothScroll': {} }" href="introduction.html#introduction-principles" data-qp-ui-data-id="qp:2">原则</a>
          </li>
        </ul>
      </nav>
            ...
            <div>
              <div class="col-list">
                <section class="module-figure col-2">
                  <div class="module">
                    <p>创造一个将经典的设计原则和科技、创新相结合的设计语言。</p>
                  </div>
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/material-design/introduction/materialdesign_goals_language.png"/>
                      </div>
                    </figure>
                  </div>
                </section>
                <section class="module-figure col-2">
                  <div class="module">
                    <p>开发一个能在不同平台、不同设备上提供一致的体验的底层系统。遵循基本的移动设计定则，并同时支持触摸、语音、鼠标、键盘等输入方式。</p>
                  </div>
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/material-design/introduction/materialdesign_goals_system.png"/>
                      </div>
                    </figure>
                  </div>
                </section>
              ...
              <div class="col-list">
                <section class="figure-figure-figure col-3">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/material-design/introduction/materialdesign_principles_metaphor.png"/>
                      </div>
                      <figcaption>
