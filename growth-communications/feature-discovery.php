              ...
              <div class="col-list">
                <section class="module-figure col-2">
                  <div class="module">
                    ...
                    <p>在移动端，点击目标拥有比其他 UI 元素更高的海拔高度，并且可以超过屏幕的宽度。</p>
                  </div>
                  <div class="figure">
                    <figure class="s-tag-media">
              ...
              <div class="col-list">
                <section class="module-figure col-2">
                  <div class="module">
                    ...
                    <p>如果点击目标出现在小于 280dp 的高度和 360dp 的宽度的表面上，则允许点击目标和提示背景超过屏幕的边缘（在更高的海拔高度上）。</p>
                  </div>
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 2048px">
                ...
                <section class="figure-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      ...
                      <figcaption id="design-figure-caption-12">
                        <p>涟漪用于紧接着的步骤。</p>
                      </figcaption>
                    </figure>
                  </div>
                  <div class="figure">
                    <figure class="s-tag-media">
                      ...
                      <figcaption id="design-figure-caption-13">
                        <p>toast 用于确认任务已完成。</p>
                      </figcaption>
                    </figure>
                  </div>
