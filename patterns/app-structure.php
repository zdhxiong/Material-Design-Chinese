            ...
            <section class="module-module-figure col-3">
              ...
              <div class="figure">
                <figure class="s-tag-media">
                  <div class="media">
                    <img alt="" src="../static/media/patterns/app-structure/patterns_navigation.png"/>
                  </div>
                </figure>
              </div>
            </section>
              ...
              <div class="col-list">
                ...
                <section class="figure-figure-figure col-3">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_structure1.png"/>
                      </div>
                      <figcaption>
                      ...
                      <div class="media">
                        <div class="qp-ui" data-qp-ui="{ 'VideoPlayer': {} }">
                          <video controls="" loop="" preload="metadata">
                            <source src="../static/media/patterns/app-structure/components-buttons-fab-transition_speeddial_02.webm" type="video/webm">
                            <source src="../static/media/patterns/app-structure/components-buttons-fab-transition_speeddial_02.mp4" type="video/mp4">
                            </source></source>
                          </video>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_structure3.png"/>
                      </div>
                      <figcaption>
              ...
              <div class="col-list">
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_definingyournavigation-alt.png"/>
                      </div>
                    </figure>
                  </div>
                </section>
              ...
              <div class="col-list">
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/inventory.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="module-figure col-2">
                  <div class="module">
                    ...
                    <p>Adjust priority levels as user needs change over time. </p></div>
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/prioritize.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/sequence.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/deconstruct.png"/>
                      </div>
                      <figcaption>
        ...
        <div id="navigation-up-back-buttons" class="article qp-ui" data-qp-ui="{ 'ScrollSpy': {} }" data-qp-ui-data-id="qp:3">
          ...
          <div class="article-content">
            <div>
              ...
              <div class="col-list">
                <section class="module-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_upandback1.png"/>
                      </div>
                      <figcaption>
                        <p>The Up button</p>
                      </figcaption>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_upandback2.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="module-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_upandback3.png"/>
                      </div>
                      <figcaption>
                        <p>The Back button </p>
                      </figcaption>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_upandback4.png"/>
                      </div>
                      <figcaption>
              ...
              <p>
                <strong>Exception:</strong> Navigation history is created by following links from related detail views (not unified by a list), such as browsing Play Store albums by the same artist.</p>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <div class="col-list">
                <section class="module-figure-module col-3">
                  <div class="module">
                    <h1>Activities, tasks, and intents</h1>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <div class="qp-ui" data-qp-ui="{ 'VideoPlayer': {} }">
                          <video controls="" loop="" preload="metadata">
                            <source src="../static/media/patterns/app-structure/patterns_navigation_betweenapps1.webm" type="video/webm">
                            <source src="../static/media/patterns/app-structure/patterns_navigation_betweenapps1.mp4" type="video/mp4">
                            </source></source>
                          </video>
                        </div>
                      </div>
              ...
              <div class="col-list">
                <section class="figure-figure-figure col-3">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_hierarchy_home.png"/>
                      </div>
                      <figcaption>
                        <h2>Home</h2>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_hierarchy_parent-child.png"/>
                      </div>
                      <figcaption>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_hierarchy_navigation.png"/>
                      </div>
                      <figcaption>
                        <h2>Navigation </h2>
                ...
                <section class="figure-figure-figure col-3">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_hierarchy_siblings.png"/>
                      </div>
                      <figcaption>
                        <h2>Siblings</h2>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_hierarchy_collections.png"/>
                      </div>
                      <figcaption>
                        <h2>Collections</h2>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_hierarchy_links.png"/>
                      </div>
                      <figcaption>
                        <h2>Links</h2>
              ...
              <div class="col-list">
                <section class="module-figure-module col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterns_embedded1.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="module-figure-module col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterns_tabs1.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterns_tabs2.png"/>
                      </div>
                      <figcaption>
                    ...
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterns_tabs3.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="module-figure-module col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterns_bottomnav1.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterns_bottomnav2.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="module-figure-module col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterns_bottomnav3.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterns_bottomnav4.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="module-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterns_navdrawer1.png"/>
                      </div>
                      <figcaption>
                    ...
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterns_navdrawer3.png"/>
                      </div>
                      <figcaption>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterns_navdrawer2.png"/>
                      </div>
                      <figcaption>
                    ...
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterns_navdrawer4.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterns_nested1.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="module-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterns_expanding1.png"/>
                      </div>
                      <figcaption>
                        <p>Desktop example of an expanding left nav</p>
                      </figcaption>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterns_expanding2.png"/>
                      </div>
                    </figure>
                  </div>
                </section>
                <section class="module-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterns_cascading1.png"/>
                      </div>
                      <figcaption>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterns_cascading2.png"/>
                      </div>
                    </figure>
                  </div>
                </section>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <div class="qp-ui" data-qp-ui="{ 'VideoPlayer': {} }">
                          <video controls="" loop="" preload="metadata">
                            <source src="../static/media/patterns/app-structure/Expanding - Overscroll Top.webm" type="video/webm">
                            <source src="../static/media/patterns/app-structure/Expanding - Overscroll Top.mp4" type="video/mp4">
                            </source></source>
                          </video>
                        </div>
                      </div>
              ...
              <div class="col-list">
                <section class="module-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterncombinations1.png"/>
                      </div>
                      <figcaption>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterncombinations2.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterncombinations3.png"/>
                      </div>
                      <figcaption>
                    ...
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterncombinations4.png"/>
                      </div>
                      <figcaption>
              ...
              <div class="col-list">
                <section class="module-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterncombinations5.png"/>
                      </div>
                      <figcaption>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterncombinations6.png"/>
                      </div>
                      <figcaption>
                        <p>Mobile example of an open left nav</p>
                      </figcaption>
              ...
              <div class="col-list">
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterncombinations7.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterncombinations8.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterncombinations9.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/patterns/app-structure/patterns_navigation_patterncombinations10.png"/>
                      </div>
                      <figcaption>
                        <p>Desktop example of a nested left nav with tabs</p></figcaption>
                    </figure>
                  </div>
                </section>
              </div>
