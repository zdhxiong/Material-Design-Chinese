                ...
                <figure class="s-tag-media">
                  <div class="media" style="max-width: 3000px">
                    <div class="frame " style="padding-top: 100.0%">
                      <img alt="" src="<?= static_url('../static/media/patterns/gestures/patterns_gestures.png'); ?>" loading="lazy"/>
                    </div>
                  </div>
                </figure>
              </div>
                ...
                <section class="figure-figure-figure col-3">
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="touch-mechanics-figure-caption-0" src="<?= static_url('../static/media/patterns/gestures/patterns-gestures-gestures-touch_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="touch-mechanics-figure-caption-1" src="<?= static_url('../static/media/patterns/gestures/patterns-gestures-gestures-double-touch_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="touch-mechanics-figure-caption-2" src="<?= static_url('../static/media/patterns/gestures/patterns-gestures-gestures-swipe_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="figure-figure-figure col-3">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="touch-mechanics-figure-caption-3" src="<?= static_url('../static/media/patterns/gestures/patterns-gestures-gestures-long-press_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="touch-mechanics-figure-caption-4" src="<?= static_url('../static/media/patterns/gestures/patterns-gestures-gestures-long-press-drag_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="touch-mechanics-figure-caption-5" src="<?= static_url('../static/media/patterns/gestures/Patterns-Gestures-TouchMechanics-6-Long-press-drag_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="figure-figure-figure col-3">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="touch-mechanics-figure-caption-6" src="<?= static_url('../static/media/patterns/gestures/patterns-gestures-gestures-pinch-open_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="touch-mechanics-figure-caption-7" src="<?= static_url('../static/media/patterns/gestures/patterns-gestures-gestures-pinch-closed_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="touch-mechanics-figure-caption-8" src="<?= static_url('../static/media/patterns/gestures/patterns-gestures-gestures-two-finger-touch_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="figure-figure-figure col-3">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="touch-mechanics-figure-caption-9" src="<?= static_url('../static/media/patterns/gestures/patterns-gestures-gestures-two-finger-swipe_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="touch-mechanics-figure-caption-10" src="<?= static_url('../static/media/patterns/gestures/patterns-gestures-gestures-two-finger-long-press_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="touch-mechanics-figure-caption-11" src="<?= static_url('../static/media/patterns/gestures/patterns-gestures-gestures-two-finger-long-press-drag_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="figure-figure-module col-3">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="touch-mechanics-figure-caption-12" src="<?= static_url('../static/media/patterns/gestures/patterns-gestures-gestures-two-finger-double-touch_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="touch-mechanics-figure-caption-13" src="<?= static_url('../static/media/patterns/gestures/patterns-gestures-gestures-rotate_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module col-1">
                  <div class="module"><p>滑动手势的功能因情境而异。手指移动的速度是拖拽、滑动和甩动之间最大的区别。</p>
                    ...
                    <ul class="lst-kix_hdososeh0xki-0 start">
                      <li>滑动是否变成甩动，取决于结束速度、以及受影响的元素是否已经越过阈值（或超过了可以撤销操作的点）</li>
                ...
                <section class="module-figure-module col-3 h3-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="drag-swipe-or-fling-details-figure-caption-0" src="<?= static_url('../static/media/patterns/gestures/Patterns-Gestures-TouchActivities-02_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-module col-3 h3-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="drag-swipe-or-fling-details-figure-caption-1" src="<?= static_url('../static/media/patterns/gestures/Patterns-Gestures-TouchActivities-02_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 151.111111111%">
                          <img alt="" aria-describedby="drag-swipe-or-fling-details-figure-caption-2" src="<?= static_url('../static/media/patterns/gestures/Patterns-Gestures-TouchActivities-03_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-module col-3 h3-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="drag-swipe-or-fling-details-figure-caption-3" src="<?= static_url('../static/media/patterns/gestures/Patterns-Gestures-TouchActivities-04_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-module col-3 h3-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 100.0%">
                          <img alt="" aria-describedby="drag-swipe-or-fling-details-figure-caption-4" src="<?= static_url('../static/media/patterns/gestures/Patterns-Gestures-TouchActivities-05_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-module col-3 h3-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 100.0%">
                          <img alt="" aria-describedby="drag-swipe-or-fling-details-figure-caption-5" src="<?= static_url('../static/media/patterns/gestures/Patterns-Gestures-TouchActivities-06_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-module col-3 h3-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 100.0%">
                          <img alt="" aria-describedby="drag-swipe-or-fling-details-figure-caption-6" src="<?= static_url('../static/media/patterns/gestures/Patterns-Gestures-TouchActivities-07_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-module col-3 h3-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="drag-swipe-or-fling-details-figure-caption-7" src="<?= static_url('../static/media/patterns/gestures/Patterns-Gestures-TouchActivities-08_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-module col-3 h3-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="drag-swipe-or-fling-details-figure-caption-8" src="<?= static_url('../static/media/patterns/gestures/Patterns-Gestures-TouchActivities-09_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-module col-3 h3-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 75.5555555556%">
                          <img alt="" aria-describedby="drag-swipe-or-fling-details-figure-caption-9" src="<?= static_url('../static/media/patterns/gestures/Patterns-Gestures-TouchActivities-10_large_xhdpi.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
