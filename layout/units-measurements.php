                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 68.4210526316%">
                          <img alt="" aria-describedby="pixel-density-figure-caption-0" src="<?= static_url('../static/media/layout/units-measurements/layout_units_density1.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 68.4210526316%">
                          <img alt="" aria-describedby="pixel-density-figure-caption-1" src="<?= static_url('../static/media/layout/units-measurements/layout_units_density2.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 68.4210526316%">
                          <img alt="" src="<?= static_url('../static/media/layout/units-measurements/layout_units_dp.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    </figure>
                  </div>
