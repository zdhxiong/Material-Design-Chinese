                ...
                <section class="module-figure-figure col-3">
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 111.388888889%">
                          <img alt="" aria-describedby="baseline-grids-figure-caption-0" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_baseline2.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 111.388888889%">
                          <img alt="" aria-describedby="baseline-grids-figure-caption-1" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_baseline3.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 2320px">
                        <div class="frame " style="padding-top: 39.0517241379%">
                          <img alt="" aria-describedby="baseline-grids-figure-caption-2" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_baseline5.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
          ...
          <div class="article-content">
            <div>
              ...
              <div class="modulettes">
                <a class="modulette download trackdl" download="" href="<?= static_url('../static/media/layout/metrics-keylines/Layout_Mobile_Whiteframe.ai'); ?>" title="Mobile layout template">
              ...
              <div class="modulettes">
                <a class="modulette download trackdl" download="" href="<?= static_url('../static/media/layout/metrics-keylines/Layout_Tablet_Whiteframe.ai'); ?>" title="Tablet layout template">
                  <img alt="" class="icon download-icon" src="<?= static_url('../static/spec/images/callouts/download.svg'); ?>" loading="lazy">
                  <div class="info">
              ...
              <div class="modulettes">
                <a class="modulette download trackdl" download="" href="<?= static_url('../static/media/layout/metrics-keylines/Layout_Desktop_Whiteframe.ai'); ?>" title="Desktop Layout Template">
                  <img alt="" class="icon download-icon" src="<?= static_url('../static/spec/images/callouts/download.svg'); ?>" loading="lazy">
                  <div class="info">
                ...
                <section class="module-figure-figure col-3">
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="keylines-spacing-figure-caption-0" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_keyline_mobile2.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="keylines-spacing-figure-caption-1" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_keyline_mobile3.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="keylines-spacing-figure-caption-2" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_keyline_mobile5.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="keylines-spacing-figure-caption-3" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_keyline_mobile6.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="keylines-spacing-figure-caption-4" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_keyline_mobile8.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="keylines-spacing-figure-caption-5" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_keyline_mobile9.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="keylines-spacing-figure-caption-6" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_keyline_mobile14.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame" style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="keylines-spacing-figure-caption-7" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_keyline_mobile15.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 2048px">
                        <div class="frame " style="padding-top: 75.0%">
                          <img alt="" aria-describedby="keylines-spacing-figure-caption-8" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_keyline_tablet2.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 2048px">
                        <div class="frame " style="padding-top: 75.0%">
                          <img alt="" aria-describedby="keylines-spacing-figure-caption-9" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_keyline_tablet3.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 2048px">
                        <div class="frame " style="padding-top: 75.0%">
                          <img alt="" aria-describedby="keylines-spacing-figure-caption-10" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_keyline_tablet5.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 2048px">
                        <div class="frame " style="padding-top: 75.0%">
                          <img alt="" aria-describedby="keylines-spacing-figure-caption-11" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_keyline_tablet6.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 2320px">
                        <div class="frame " style="padding-top: 68.9655172414%">
                          <img alt="" aria-describedby="keylines-spacing-figure-caption-12" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_keylines_desktop1.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3">
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 66.9444444444%">
                          <img alt="" aria-describedby="keylines-spacing-figure-caption-13" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_keylines_desktop3.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 66.9444444444%">
                          <img alt="" aria-describedby="keylines-spacing-figure-caption-14" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_keylines_desktop4.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="ratio-keylines-figure-caption-0" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_ratiokeylines1.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="ratio-keylines-figure-caption-1" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_ratiokeylines2.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="ratio-keylines-figure-caption-2" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_ratiokeylines3.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="ratio-keylines-figure-caption-3" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_ratiokeylines4.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 47.3684210526%">
                          <img alt="" aria-describedby="sizing-by-increments-figure-caption-0" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_incremental2.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame" style="padding-top: 47.3684210526%">
                          <img alt="" aria-describedby="sizing-by-increments-figure-caption-1" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_incremental3.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 47.3684210526%">
                          <img alt="" aria-describedby="sizing-by-increments-figure-caption-2" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_incremental4.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="touch-target-size-figure-caption-0" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_touchtarget1.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="touch-target-size-figure-caption-1" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_touchtarget3.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="touch-target-size-figure-caption-2" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_touchtarget2.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="touch-target-size-figure-caption-3" src="<?= static_url('../static/media/layout/metrics-keylines/layout_metrics_touchtarget4.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
