                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 47.3684210526%">
                          <img alt="" aria-describedby="how-paper-works-figure-caption-0" src="<?= static_url('../static/media/layout/principles/layout_principles_papercraft_paper1.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure col-2 h1-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 47.3684210526%">
                          <img alt="" aria-describedby="how-paper-works-figure-caption-1" src="<?= static_url('../static/media/layout/principles/layout_principles_papercraft_paper2.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="module">
                    <p>
                      <figure class="s-tag-media">
                        <div class="media" style="max-width: 1520px">
                          <div class="frame" style="padding-top: 47.3684210526%">
                            <img alt="" aria-describedby="floating-action-button-figure-caption-0" src="<?= static_url('../static/media/layout/principles/layout_principles_papercraft_actions1.png'); ?>" loading="lazy"/>
                          </div>
                        </div>
                  ...
                  <div class="module">
                    <p>
                      <figure class="s-tag-media">
                        <div class="media" style="max-width: 1520px">
                          <div class="frame " style="padding-top: 47.3684210526%">
                            <img alt="" aria-describedby="floating-action-button-figure-caption-1" src="<?= static_url('../static/media/layout/principles/layout_principles_papercraft_actions2.png'); ?>" loading="lazy"/>
                          </div>
                        </div>
