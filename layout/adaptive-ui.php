...
$vars = array(
  ...
  'theme_color' => '#AD1457',
  'color_name' => 'pink',
  'prev_title' => 'Structure',
  'prev_path' => 'layout/structure',
  'next_title' => 'Split screen',
  'next_path' => 'layout/split-screen'
);
...
<div id="grid-cont">
  <section class="grid_outer chapter">
    ...
    <h1 class="chapter-title">Responsive UI</h1>

    <div class="chapter-content">

      <div class="article-content chapter-intro">
        <div>
          <h1>Responsive layouts in material design adapt to any possible screen size. This UI guidance includes a flexible grid that ensures consistency across layouts, breakpoint details about how content reflows on different screens, and a description of how an app can scale from small to extra-large screens.</h1>
        </div>
      </div>
      ...
      <nav class="chapter-toc">
        ...
        <ul>
          <li>
            <a class="gweb-smoothscroll-control qp-ui" data-qp-ui="{ 'SmoothScroll': {} }" href="adaptive-ui.html#responsive-ui-breakpoints" data-qp-ui-data-id="qp:1">Breakpoints</a>
          </li>
          <li>
            <a class="gweb-smoothscroll-control qp-ui" data-qp-ui="{ 'SmoothScroll': {} }" href="adaptive-ui.html#responsive-ui-grid" data-qp-ui-data-id="qp:2">Grid</a>
          </li>
          <li>
      ...
      <div class="article-list">
        ...
        <div id="responsive-ui-breakpoints" class="article qp-ui" data-qp-ui="{ 'ScrollSpy': {} }" data-qp-ui-data-id="qp:1">
          ...
          <div class="article-content">
            <div>
              <p>For optimal user experience, material design user interfaces should adapt layouts for the following breakpoint widths: 480, 600, 840, 960, 1280, 1440, and 1600dp.</p>
                ...
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/layout/adaptive-ui/layout_adaptive_breakpoints_01.png"/>
                      </div>
                    </figure>
                  </div>
                </section>
                      ...
                      <div class="media">
                        <div class="qp-ui" data-qp-ui="{ 'VideoPlayer': {} }">
                          <video controls="" loop="" preload="metadata">
                            <source src="../static/media/layout/adaptive-ui/layout_adaptiveUI_grid_01_hero.webm" type="video/webm">
                            <source src="../static/media/layout/adaptive-ui/layout_adaptiveUI_grid_01_hero.mp4" type="video/mp4">
                            </source></source>
                          </video>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <div class="qp-ui" data-qp-ui="{ 'VideoPlayer': {} }">
                          <video controls="" loop="" preload="metadata">
                            <source src="../static/media/layout/adaptive-ui/layout_adaptiveUI_grid_02_margins.webm" type="video/webm">
                            <source src="../static/media/layout/adaptive-ui/layout_adaptiveUI_grid_02_margins.mp4" type="video/mp4">
                            </source></source>
                          </video>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <div class="qp-ui" data-qp-ui="{ 'VideoPlayer': {} }">
                          <video controls="" loop="" preload="metadata">
                            <source src="../static/media/layout/adaptive-ui/layout_adaptiveUI_grid_03_width.webm" type="video/webm">
                            <source src="../static/media/layout/adaptive-ui/layout_adaptiveUI_grid_03_width.mp4" type="video/mp4">
                            </source></source>
                          </video>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <div class="qp-ui" data-qp-ui="{ 'VideoPlayer': {} }">
                          <video controls="" loop="" preload="metadata">
                            <source src="../static/media/layout/adaptive-ui/layout_adaptiveUI_grid_04_behaviorPermanent.webm" type="video/webm">
                            <source src="../static/media/layout/adaptive-ui/layout_adaptiveUI_grid_04_behaviorPermanent.mp4" type="video/mp4">
                            </source></source>
                          </video>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <div class="qp-ui" data-qp-ui="{ 'VideoPlayer': {} }">
                          <video controls="" loop="" preload="metadata">
                            <source src="../static/media/layout/adaptive-ui/layout_adaptiveUI_grid_05_behaviorSqueezePush.webm" type="video/webm">
                            <source src="../static/media/layout/adaptive-ui/layout_adaptiveUI_grid_05_behaviorSqueezePush.mp4" type="video/mp4">
                            </source></source>
                          </video>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <div class="qp-ui" data-qp-ui="{ 'VideoPlayer': {} }">
                          <video controls="" loop="" preload="metadata">
                            <source src="../static/media/layout/adaptive-ui/layout_adaptiveUI_grid_06_behaviorOverlay.webm" type="video/webm">
                            <source src="../static/media/layout/adaptive-ui/layout_adaptiveUI_grid_06_behaviorOverlay.mp4" type="video/mp4">
                            </source></source>
                          </video>
                        </div>
                      </div>
        ...
        <div id="responsive-ui-surface-behaviors" class="article qp-ui" data-qp-ui="{ 'ScrollSpy': {} }" data-qp-ui-data-id="qp:3">
          ...
          <div class="article-content">
            <div><p>When a screen size changes, the UI adapts using the following surface-specific behaviors. </p>
              <div class="col-list">
                <section class="module-module col-2">
                  <div class="module">
                    <p>Visibility</p>
                  ...
                  <div class="module">
                    <table class="s-tag-table">
                      ...
                      <tr>
                        ...
                        <td colspan="1" rowspan="1"><p>Surface visibility can be toggled between visible and hidden. When visible, interacting with other elements on the screen toggles the surface to become hidden or minimized.</p></td>
                      </tr>
                      </tbody>
                    </table>
                  </div>
        ...
        <div id="responsive-ui-patterns" class="article qp-ui" data-qp-ui="{ 'ScrollSpy': {} }" data-qp-ui-data-id="qp:4">
          ...
          <div class="article-content">
            <div><p>As screen space increases, the following responsive patterns may be applied:</p>
              ...
              <div class="col-list">
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/layout/adaptive-ui/layout_adaptiveUI_patterns_01_reveal.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/layout/adaptive-ui/layout_adaptiveUI_patterns_02_reveal.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/layout/adaptive-ui/layout_adaptiveUI_patterns_03_reveal.png"/>
                      </div>
                      <figcaption>
              ...
              <div class="col-list">
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/layout/adaptive-ui/layout_adaptiveUI_patterns_04_transform.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/layout/adaptive-ui/layout_adaptiveUI_patterns_05_transform.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/layout/adaptive-ui/layout_adaptiveUI_patterns_06_transform.png"/>
                      </div>
                      <figcaption>
              ...
              <div class="col-list">
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/layout/adaptive-ui/layout_adaptiveUI_patterns_07_divide.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/layout/adaptive-ui/layout_adaptiveUI_patterns_08_divide.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/layout/adaptive-ui/layout_adaptiveUI_patterns_09_divide.png"/>
                      </div>
                    </figure>
              ...
              <div class="col-list">
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/layout/adaptive-ui/layout_adaptiveUI_patterns_10_reflow.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/layout/adaptive-ui/layout_adaptiveUI_patterns_11_reflow.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/layout/adaptive-ui/layout_adaptiveUI_patterns_12_reflow.png"/>
                      </div>
                      <figcaption>
              ...
              <div class="col-list">
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/layout/adaptive-ui/layout_adaptiveUI_patterns_13_expand.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/layout/adaptive-ui/layout_adaptiveUI_patterns_14_expand.png"/>
                      </div>
                      <figcaption>
              ...
              <div class="col-list">
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/layout/adaptive-ui/layout_adaptiveUI_patterns_15_position.png"/>
                      </div>
                      <figcaption>
                ...
                <section class="figure col-1">
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media">
                        <img alt="" src="../static/media/layout/adaptive-ui/layout_adaptiveUI_patterns_16_position.png"/>
                      </div>
                      <figcaption>
