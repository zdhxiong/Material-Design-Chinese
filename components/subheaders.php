                ...
                <figure class="s-tag-media">
                  <div class="media" style="max-width: 3000px">
                    <div class="frame " style="padding-top: 100.0%">
                      <img alt=""  src="<?= static_url('../static/media/components/subheaders/components_subheaders.png'); ?>" loading="lazy"/>
                    </div>
                  </div>
                </figure>
              </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 80.0%">
                          <img alt="" aria-describedby="list-subheaders-figure-caption-0" src="<?= static_url('../static/media/components/subheaders/components_subheaders1.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="list-subheaders-figure-caption-1" src="<?= static_url('../static/media/components/subheaders/components_subheaders2.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 80.0%">
                          <img alt="" aria-describedby="list-subheaders-figure-caption-2" src="<?= static_url('../static/media/components/subheaders/components_subheaders3.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="list-subheaders-figure-caption-3" src="<?= static_url('../static/media/components/subheaders/components_subheaders4.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3">
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 77.7777777778%">
                          <img alt="" aria-describedby="grid-subheaders-figure-caption-0" src="<?= static_url('../static/media/components/subheaders/components_subheaders5.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="grid-subheaders-figure-caption-1" src="<?= static_url('../static/media/components/subheaders/components_subheaders6.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3">
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 57.7777777778%">
                          <img alt="" aria-describedby="menu-subheaders-figure-caption-0" src="<?= static_url('../static/media/components/subheaders/components_subheaders7.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="menu-subheaders-figure-caption-1" src="<?= static_url('../static/media/components/subheaders/components_subheaders8.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
