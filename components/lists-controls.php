                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 49.7368421053%">
                          <img alt="" aria-describedby="usage-figure-caption-0" src="<?php static_url('../static/media/components/lists-controls/components_listcontrols_usage.png'); ?>"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 37.8947368421%">
                          <img alt="" aria-describedby="types-of-list-controls-figure-caption-0" src="<?php static_url('../static/media/components/lists-controls/components_listcontrols_checkbox1.png'); ?>"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 41.0526315789%">
                          <img alt="" aria-describedby="types-of-list-controls-figure-caption-1" src="<?php static_url('../static/media/components/lists-controls/components_listcontrols_checkbox2.png'); ?>"/>
                        </div>
                      </div>
                ...
                <section class="module-figure col-2 h1-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 37.8947368421%">
                          <img alt="" aria-describedby="types-of-list-controls-figure-caption-2" src="<?php static_url('../static/media/components/lists-controls/components_listcontrols_switch.png'); ?>"/>
                        </div>
                      </div>
                ...
                <section class="module-figure col-2 h1-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 41.0526315789%">
                          <img alt="" aria-describedby="types-of-list-controls-figure-caption-3" src="<?php static_url('../static/media/components/lists-controls/components_listcontrols_reorder.png'); ?>"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3 h1-spacing">
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="types-of-list-controls-figure-caption-4" src="<?php static_url('../static/media/components/lists-controls/components_listcontrols_expand1.png'); ?>"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="types-of-list-controls-figure-caption-5" src="<?php static_url('../static/media/components/lists-controls/components_listcontrols_expand2.png'); ?>"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3">
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 73.3333333333%">
                          <img alt="" aria-describedby="types-of-list-controls-figure-caption-6" src="<?php static_url('../static/media/components/lists-controls/components_listcontrols_expand3.png'); ?>"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 73.3333333333%">
                          <img alt="" aria-describedby="types-of-list-controls-figure-caption-7" src="<?php static_url('../static/media/components/lists-controls/components_listcontrols_expand4.png'); ?>"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3 h1-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="types-of-list-controls-figure-caption-8" src="<?php static_url('../static/media/components/lists-controls/components_listcontrols_leave1.png'); ?>"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="types-of-list-controls-figure-caption-9" src="<?php static_url('../static/media/components/lists-controls/components_listcontrols_leave2.png'); ?>"/>
                        </div>
                      </div>
                ...
                <section class="module-figure col-2 h1-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 37.8947368421%">
                          <img alt="" aria-describedby="types-of-menu-controls-figure-caption-0" src="<?php static_url('../static/media/components/lists-controls/components_listcontrols_menu1.png'); ?>"/>
                        </div>
                      </div>
                ...
                <section class="module-figure col-2 h1-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 37.8947368421%">
                          <img alt="" aria-describedby="types-of-menu-controls-figure-caption-1" src="<?php static_url('../static/media/components/lists-controls/components_listcontrols_menu2.png'); ?>"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 33.6842105263%">
                          <img alt="" aria-describedby="types-of-menu-controls-figure-caption-2" src="<?php static_url('../static/media/components/lists-controls/components_listcontrols_menu3.png'); ?>"/>
                        </div>
                      </div>
