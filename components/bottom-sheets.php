                ...
                <figure class="s-tag-media">
                  <div class="media" style="max-width: 3000px">
                    <div class="frame" style="padding-top: 100.0%">
                      <img alt="" src="<?= static_url('../static/media/components/bottom-sheets/components_bottom_sheets.png'); ?>" loading="lazy"/>
                    </div>
                  </div>
                </figure>
              </div>
                ...
                <section class="module-figure-figure col-3">
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame" style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="usage-figure-caption-0" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_usage2.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame" style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="usage-figure-caption-1" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_usage1.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame" style="padding-top: 149.166666667%">
                          <img alt="" aria-describedby="persistent-bottom-sheets-figure-caption-0" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_persistent2.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame" style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="persistent-bottom-sheets-figure-caption-1" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_persistent5.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame" style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="persistent-bottom-sheets-figure-caption-2" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_persistent6.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 75.0%">
                          <img alt="" aria-describedby="persistent-bottom-sheets-figure-caption-3" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_persistent7.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame" style="padding-top: 75.0%">
                          <img alt="" aria-describedby="persistent-bottom-sheets-figure-caption-4" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_persistent8.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 64.4736842105%">
                          <img alt="" aria-describedby="persistent-bottom-sheets-figure-caption-5" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_persistent9.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 149.166666667%">
                          <img alt="" aria-describedby="modal-bottom-sheets-figure-caption-0" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_modal1.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 149.166666667%">
                          <img alt="" aria-describedby="modal-bottom-sheets-figure-caption-1" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_modal2.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3 h2-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 149.166666667%">
                          <img alt="" aria-describedby="modal-bottom-sheets-figure-caption-2" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_modal3.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 148.888888889%">
                          <img alt="" aria-describedby="modal-bottom-sheets-figure-caption-3" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_modal4.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-module col-3 h2-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 148.888888889%">
                          <img alt="" aria-describedby="modal-bottom-sheets-figure-caption-4" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_modal7.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 52.6315789474%">
                          <img alt="" aria-describedby="modal-bottom-sheets-figure-caption-5" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_modal6.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3">
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 72.2222222222%">
                          <img alt="" aria-describedby="modal-bottom-sheets-figure-caption-6" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_modal_do.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 72.2222222222%">
                          <img alt="" aria-describedby="modal-bottom-sheets-figure-caption-7" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_modal_dont.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3 h2-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="modal-bottom-sheets-figure-caption-8" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_modal9.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="modal-bottom-sheets-figure-caption-9" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_modal11.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="modal-bottom-sheets-figure-caption-10" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_modal10.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="modal-bottom-sheets-figure-caption-11" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_modal12.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 82.1052631579%">
                          <img alt="" aria-describedby="modal-bottom-sheets-figure-caption-12" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_modal15.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure col-2">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 75.0%">
                          <img alt="" aria-describedby="modal-bottom-sheets-figure-caption-13" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_modal13.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 1520px">
                        <div class="frame " style="padding-top: 75.0%">
                          <img alt="" aria-describedby="modal-bottom-sheets-figure-caption-14" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_modal14.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3">
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 97.2222222222%">
                          <img alt="" aria-describedby="behavior-figure-caption-0" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_behavior1.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 97.2222222222%">
                          <img alt="" aria-describedby="behavior-figure-caption-1" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_behavior2.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 97.5%">
                          <img alt="" aria-describedby="behavior-figure-caption-2" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_behavior3.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3 h2-spacing">
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 83.3333333333%">
                          <img alt="" aria-describedby="specs-figure-caption-0" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_specs1.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 83.3333333333%">
                          <img alt="" aria-describedby="specs-figure-caption-1" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_specs2.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3 h2-spacing">
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 110.0%">
                          <img alt="" aria-describedby="specs-figure-caption-2" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_specs3.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 110.0%">
                          <img alt="" aria-describedby="specs-figure-caption-3" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_specs4.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3 h2-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 110.0%">
                          <img alt="" aria-describedby="specs-figure-caption-4" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_specs7.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 110.0%">
                          <img alt="" aria-describedby="specs-figure-caption-5" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_specs8.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3 h2-spacing">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame" style="padding-top: 110.0%">
                          <img alt="" aria-describedby="specs-figure-caption-6" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_specs12.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame" style="padding-top: 110.0%">
                          <img alt="" aria-describedby="specs-figure-caption-7" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_specs13.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                ...
                <section class="module-figure-figure col-3">
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 177.777777778%">
                          <img alt="" aria-describedby="specs-figure-caption-8" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_specs9.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                  ...
                  <div class="figure">
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 720px">
                        <div class="frame " style="padding-top: 83.3333333333%">
                          <img alt="" aria-describedby="specs-figure-caption-9" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_specs10.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
                    ...
                    <figure class="s-tag-media">
                      <div class="media" style="max-width: 2320px">
                        <div class="frame " style="padding-top: 66.724137931%">
                          <img alt="" aria-describedby="specs-figure-caption-10" src="<?= static_url('../static/media/components/bottom-sheets/components_bottomsheets_specs11.png'); ?>" loading="lazy"/>
                        </div>
                      </div>
