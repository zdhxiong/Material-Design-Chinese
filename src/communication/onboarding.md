...
[en]: <> (Specs)
* [译文](#usage)
* [译文](#self-select-model)
* [译文](#quickstart-model)
* [译文](#top-user-benefits-model)
* [译文](#specs)
...
译文     | 译文
-----   | -----
<ul><li>译文</li><li>译文</li><li>译文</li></ul>     | <ul><li>译文</li><li>译文</li><li>译文</li></ul>
...
![]({assets_path}/communication/onboarding/onboarding-illo-01.png)
...
&nbsp;    | 译文                                 | 译文       | 译文
------    | -------                             | -------   | --------
译文       | <ul><li>译文</li><li>译文</li></ul>  | 译文   | <ul><li>译文</li><li>译文</li></ul>
译文       | <ul><li>译文</li><li>译文</li></ul>  | 译文   | <ul><li>译文</li><li>译文</li></ul>
译文       | 译文                                | 译文   | <ul><li>译文</li><li>译文</li></ul>

[en]: <> (Self-select model)
<h2 id="self-select-model">译文</h2>
...
[en]: <> (Top user benefits model)
<h2 id="top-user-benefits-model">译文</h2>
...
![]({assets_path}/color/applying-color-to-ui/communication-onboarding-redline2.png)
...
![]({assets_path}/color/applying-color-to-ui/communication-onboarding-redline3.png)
